    ...
    <div id="stats-nav">
      <nav id="stats-nav-container">
        ...
        <div className="stat">
          ...
          {currentData && (
            <Link href="/charts/price">
              <a>${format(currentData.bitcoinPrice.toFixed(2))}</a>
            </Link>
          )}
        </div>
        <div className="stat">
          ...
          {currentData && (
            <Link href="/charts/sats">
              <a>{format(Math.round(100000000 / currentData.bitcoinPrice))}</a>
            </Link>
          )}
        </div>
        <div className="stat">
          ...
          {currentData && (
            <Link href="/charts/mempool">
              <a>{format(currentData.mempoolSize)} txns</a>
            </Link>
          )}
        </div>
        <div className="stat">
